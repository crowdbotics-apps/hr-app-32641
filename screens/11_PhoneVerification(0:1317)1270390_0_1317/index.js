    ...
    >
          ...
          <View style={styles.View_0_1327}>
            <View style={styles.View_0_1328}>
              <View style={styles.View_0_1329}>
                <Text style={styles.Text_0_1329}>OTP Verification</Text>
              </View>
            </View>
          </View>
        </View>
          ...
          <View style={styles.View_0_1333}>
            <View style={styles.View_0_1334}>
              <View style={styles.View_0_1335}>
                <Text style={styles.Text_0_1335}>8</Text>
              </View>
            </View>
          </View>
        </View>
          ...
          <View style={styles.View_0_1338}>
            <View style={styles.View_0_1339}>
              <View style={styles.View_0_1340}>
                <Text style={styles.Text_0_1340}>Verify Now</Text>
              </View>
            </View>
          </View>
        </View>
          ...
          <View style={styles.View_0_1346}>
            ...
            <View style={styles.View_0_1349}>
              <View style={styles.View_0_1350}>
                <Text style={styles.Text_0_1350}>(+880) 111 222 333</Text>
              </View>
            </View>
          </View>
          <View style={styles.View_0_1351}>
            ...
            <View style={styles.View_0_1354}>
              <View style={styles.View_0_1355}>
                <Text style={styles.Text_0_1355}>Resend Code</Text>
              </View>
            </View>
          </View>
          <View style={styles.View_0_1356}>
            <View style={styles.View_0_1357}>
              <View style={styles.View_0_1358}>
                <Text style={styles.Text_0_1358}>1:20 Sec left</Text>
              </View>
            </View>
          </View>
        </View>
      ...
      <View style={styles.View_0_1359}>
        ...
        <ImageBackground
          ...
          style={styles.ImageBackground_0_1362}
        />
      </View>
      <View style={styles.View_0_1364}>
        <View style={styles.View_0_1365}>
          <View style={styles.View_0_1366} />
        </View>
        <View style={styles.View_0_1367}>
          <View style={styles.View_0_1368}>
            <View style={styles.View_0_1369}>
              <Text style={styles.Text_0_1369}>Phone Verification</Text>
            </View>
          </View>
        </View>
        <View style={styles.View_0_1370}>
          <View style={styles.View_0_1371}>
            <View style={styles.View_0_1372}>
              <View style={styles.View_0_1373}>
                <Text style={styles.Text_0_1373}>9:41</Text>
              </View>
            </View>
          </View>
