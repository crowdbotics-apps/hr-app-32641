  ...
  render = () => (
    ...
    >
          ...
          <View style={styles.View_0_1787}>
            <View style={styles.View_0_1788}>
              <View style={styles.View_0_1789}>
                <Text style={styles.Text_0_1789}>Account Created!</Text>
              </View>
            </View>
          </View>
          <View style={styles.View_0_1790}>
            <View style={styles.View_0_1791}>
              <View style={styles.View_0_1792}>
                <Text style={styles.Text_0_1792}>
                  Your account had beed created
                </Text>
              </View>
            </View>
            <View style={styles.View_0_1793}>
              <View style={styles.View_0_1794}>
                <Text style={styles.Text_0_1794}>successfully.</Text>
              </View>
            </View>
            <View style={styles.View_0_1795}>
              <View style={styles.View_0_1796}>
                <Text style={styles.Text_0_1796}>
                  Please sign in to use your account
                </Text>
              </View>
              <View style={styles.View_0_1797}>
                <Text style={styles.Text_0_1797}>and enjoy</Text>
              </View>
            </View>
          </View>
        </View>
          ...
          <View style={styles.View_0_1800}>
            <View style={styles.View_0_1801}>
              <View style={styles.View_0_1802}>
                <Text style={styles.Text_0_1802}>Take me to sign in</Text>
              </View>
            </View>
          </View>
        </View>
      ...
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/1cc7/8426/c0fbd9445c082d521699286ebe14151a"
        }}
            ...
            <View style={styles.View_0_1810}>
              <View style={styles.View_0_1811}>
                <View style={styles.View_0_1812}>
                  <Text style={styles.Text_0_1812}>9:41</Text>
                </View>
              </View>
            </View>
